      ...
      CASE 'X'.
        WHEN rb_slct.
          IF screen-group4 EQ 'X'.
            screen-active = 0.
            gv_titletext = 'Yapılacak İşlem SELECT'.
          ENDIF.
        WHEN rb_insrt.
          gv_titletext = 'Yapılacak İşlem INSERT'.
        WHEN rb_updt.
          IF screen_group2 EQ 'X'.
            screen-active = 0.
            gv_titletext = 'Yapılacak İşlem UPDATE'.
          ENDIF.
        WHEN rb_dlt.
          IF screen_group3 EQ 'X'.
            screen-active = 0.
            gv_titletext = 'Yapılacak İşlem DELETE'.
          ENDIF.
      ENDCASE.
      MODIFY SCREEN.
    ENDLOOP.
